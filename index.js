...
client.on('voiceStateUpdate', async(oldState, newState) => {
  ...
  if (!oldState.channel) {
    ...
    client.channels.cache.get('878005930321657887').send(new Discord.MessageEmbed().setTitle(`Usure Coins`).setDescription(`Hey <@${newState.member.id}>, You have gained some **Usure Coins** for being active!`).setFooter(`Our coins system is still in beta, so sometimes it might work...`))
    }
  }
})
