...
module.exports.run = async (client,message,args) => {
  ...
  let bots = await x.filter(a => a.ownerID == message.author.id || a.coowners.includes(message.author.id))
   ...
   .setDescription(`<a:yes:833101995723194437> **[Usure Latest News](https://Usure.one)** <a:yes:833101995723194437>\n\n8/3/21\nwe now have an official app! Download it [here!](https://appsgeyser.io/14206789/Usure)\n\n8/4/21\nWe now have Discord-Buttons! Thanks to <@821696185647497256>! Say +help, +invite, and +news to see them!\n\nTo View More news, Click the button Below!`)
   .setColor("#7289da")
      .setFooter('Powered By Usure.one')
   
  let button = new MessageButton()
  .setStyle('url')
  .setURL('https://Usure.one/news')
