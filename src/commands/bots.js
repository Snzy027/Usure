...
module.exports.run = async (client,message,args) => {
   ...
   .setDescription(`<:search:878178296624455740>  *Searching your account*\n\n<:info:878179399596392479> *This may take a second be patient*`)
   .setColor("#7289da")
   ...
   .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
   .setDescription(`<:search:878178296624455740>  *Searched Your account*\n\n*You Own* \`\`${bots.length || 0}\`\` *Discord Bot(s) in Usure*`)
   .setColor("#7289da")
   ...
   .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
   .setDescription(`<:search:878178296624455740>  *Searched your account*\n\n<:info:878179399596392479> *You dont have any bots on our website*`)
   .setColor("#7289da")
   .setFooter(`Usurez.xyz`)
