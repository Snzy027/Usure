...
app.get("/dbl", async (req,res) => {
    res.redirect('https://discord.com/api/oauth2/authorize?client_id=876950142534688778&permissions=8&redirect_uri=https%3A%2F%2FUsure.one%2Fcallback&scope=bot')
})
